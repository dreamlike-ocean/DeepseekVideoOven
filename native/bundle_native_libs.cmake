...
set(VIDEO_OVEN_NATIVE_MANIFEST_LIBS)
if (EXISTS "${VIDEO_OVEN_NATIVE_DIR}/libs.txt")
    file(STRINGS "${VIDEO_OVEN_NATIVE_DIR}/libs.txt" VIDEO_OVEN_NATIVE_MANIFEST_LIBS)
endif()
list(APPEND VIDEO_OVEN_NATIVE_MANIFEST_LIBS ${VIDEO_OVEN_COPIED_NATIVE_LIBS})
list(REMOVE_DUPLICATES VIDEO_OVEN_NATIVE_MANIFEST_LIBS)
list(JOIN VIDEO_OVEN_NATIVE_MANIFEST_LIBS "\n" VIDEO_OVEN_NATIVE_MANIFEST)
